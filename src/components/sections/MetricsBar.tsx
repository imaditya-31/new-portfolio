...
export const MetricsBar: React.FC = () => {
  ...
  return (
    <section className="relative py-12 border-y border-white/[0.08] bg-[#07090E]/60 backdrop-blur-md">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {metricsData.map((metric, index) => (
            <motion.div
              ...
              className="p-6 rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:border-cyan-500/30 transition-all duration-300 group relative overflow-hidden"
            >
