...
export const MetricsBar: React.FC = () => {
  ...
  return (
    <section className="relative py-12 border-y border-slate-200 dark:border-white/[0.08] bg-slate-100/60 dark:bg-[#07090E]/60 backdrop-blur-md">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {metricsData.map((metric, index) => (
            <motion.div
              ...
              className="p-6 rounded-2xl bg-white dark:bg-white/[0.03] border border-slate-200/80 dark:border-white/[0.06] shadow-sm dark:shadow-none hover:border-cyan-500/40 transition-all duration-300 group relative overflow-hidden"
            >
              ...
              <div className="flex items-center gap-4 mb-3">
                <div className="p-3 rounded-xl bg-slate-100 dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.08] group-hover:scale-110 transition-transform duration-300">
                ...
                <div>
                  ...
                  <div className="text-xs font-semibold text-slate-700 dark:text-slate-200 uppercase tracking-wider">
                    {metric.label}
                  </div>
                </div>
              </div>
