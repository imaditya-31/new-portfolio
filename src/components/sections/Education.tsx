            ...
            >
              <div>
                <div className="flex items-center justify-between gap-2 mb-4">
                  <span className="text-xs font-mono text-purple-600 dark:text-purple-400 flex items-center gap-1 font-semibold">
                    <Calendar size={13} />
                    {item.period}
                  </span>
                  <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/25 text-purple-700 dark:text-purple-300 font-mono text-xs font-bold">
                    <Award size={13} className="text-purple-500 dark:text-purple-400" />
                ...
                <div className="flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400 font-mono mt-1 mb-4">
