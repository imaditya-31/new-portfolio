  ...
  return (
    <section id="experience" className="py-28 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10 max-w-5xl">
        ...
        <div className="relative pl-6 sm:pl-10 md:pl-16 border-l-2 border-slate-200 dark:border-slate-800/80 space-y-12">
              ...
              >
                ...
                <div
                  ...
                  className={`rounded-3xl p-6 sm:p-8 transition-all duration-300 cursor-pointer border ${
                    isExpanded
                      ? 'bg-white dark:bg-[#0D1117]/95 border-cyan-500/40 shadow-xl dark:shadow-[0_15px_50px_rgba(0,0,0,0.6),0_0_30px_rgba(6,182,212,0.1)]'
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {exp.isCurrent && (
                          <span className="px-2.5 py-0.5 rounded-full bg-emerald-500/15 border border-emerald-500/30 text-[11px] font-mono text-emerald-600 dark:text-emerald-400 flex items-center gap-1.5 font-bold">
                    ...
                    <div className="flex items-center gap-3 self-start sm:self-auto">
                      <div className="flex items-center gap-1 text-xs font-mono text-slate-600 dark:text-slate-400 bg-slate-100 dark:bg-white/[0.04] px-3 py-1.5 rounded-xl border border-slate-200 dark:border-white/[0.06]">
                        <Calendar size={13} className="text-cyan-600 dark:text-cyan-400" />
                        <span>{exp.period}</span>
                      </div>
                      <button
                        className="p-1.5 rounded-lg text-slate-400 group-hover:text-slate-700 dark:group-hover:text-white transition-colors"
